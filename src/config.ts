...
export const ASSET_MANAGER_ADDRESS = 'CAGP34E2VHGO7Y3NEJHCMVFMTTTIYCGBWUH7FTCMHMVYAMQBIILX5GXH';
...
export const MIN_FUNDING_AMOUNT = '35';
...
export const MAX_CONCURRENT_WALLETS = 2; // Number of wallets to run in parallel
